        ...
        <form action={formAction}>
            <div className="grid md:grid-cols-12 gap-5">
                <div className="col-span-8 bg-white p-4">
                    ...
                    <div className="mb-4">
                        <textarea rows={8} name="description" defaultValue={room.description} className="py-2 px-4 rounded-sm border border-gray-400 w-full" placeholder="Description"></textarea>
                        <div aria-live="polite" aria-atomic="true">
                ...
                <div className="col-span-4 bg-white p-4">
                    ...
                    {state?.message ? (
                        <div className="mb-4 bg-red-200 p-2">
                            <span className="text-sm text-gray-700 mt2">{state.message}</span>
                        </div>
                    ): null}
                    ...
                    })} disabled={isPending}>{isPending ? "Update.." : "Save"}</button>
                </div>
            </div>
        </form>
    )
